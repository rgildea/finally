...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/ryan/projects/finally/.claude/.gsd-surface.json`
(sibling to `/Users/ryan/projects/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/ryan/projects/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/ryan/projects/finally/.claude/skills`).
...
`/Users/ryan/projects/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/ryan/projects/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/ryan/projects/finally/.claude/.gsd-surface.json`
Install profile marker: `/Users/ryan/projects/finally/.claude/.gsd-profile`
Skill dirs: `/Users/ryan/projects/finally/.claude/skills/gsd-*/`
Engine module: `/Users/ryan/projects/finally/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/ryan/projects/finally/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
