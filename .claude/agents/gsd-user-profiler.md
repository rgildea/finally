...
<reference>
@/Users/ryan/projects/finally/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/ryan/projects/finally/.claude/get-shit-done/references/user-profiling.md` to load:
